...
What is the release version for "Artemis Console Project"? (artemis-console-project) 1.0.0: :
What is the SCM release tag or label for "Artemis Console Project"? (artemis-console-project) 1.0.0: :
What is the new development version for "Artemis Console Project"? (artemis-console-project)1.0.1-SNAPSHOT: : 1.1.0-SNAPSHOT
```
